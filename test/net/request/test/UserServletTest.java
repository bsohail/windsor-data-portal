...
public class UserServletTest {
    ...
    public void testFullName() throws IOException, ServletException {
        ...
        when(request.getParameter("companyname")).thenReturn("Uwin");
        when(request.getParameter("description")).thenReturn("This is a test");
        when(request.getPart("data")).thenReturn("D:\\Downloads\3DayParkingInfraction_YTD.csv");
